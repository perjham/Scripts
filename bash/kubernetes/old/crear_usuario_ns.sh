#!/bin/bash
#
# Script para crear un usuario de kubernetes tipo "Client certificates"
# ejecutar sh ./crear_usuario_ns.sh usuario namespace
...
cat > $repo_llaves/kubeconfig-$usuario-$namespace-admin << EOF
apiVersion: v1
kind: Config
preferences: {}
clusters:
...
EOF
echo -e ""
echo -e "Certificados y kubeconfig $repo_llaves"
echo -e ""
